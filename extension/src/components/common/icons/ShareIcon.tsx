...
const ShareIcon = ({ ...props }) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M19.2189 15.447C20.2604 16.4886 20.2604 18.1772 19.2189 19.2188C18.1773 20.2603 16.4887 20.2603 15.4472 19.2188C14.4056 18.1772 14.4056 16.4886 15.4472 15.447C16.4887 14.4055 18.1773 14.4055 19.2189 15.447"
        stroke="current"
        strokeOpacity="0.95"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M9.04004 10.81L14.96 7.84998"
        stroke="current"
        strokeOpacity="0.95"
        strokeLinecap="round"
        strokeLinejoin="round"
